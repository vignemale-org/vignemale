...
pub struct VignemaleName(String);

impl Deref for VignemaleName {
    type Target = str;
    fn deref(&self) -> &str {
        &self.0
    }
...
impl AsRef<str> for VignemaleName {
    fn as_ref(&self) -> &str {
        &self.0
    }
}

impl From<String> for VignemaleName {
    fn from(value: String) -> Self {
        Self(value)
    }
}

impl From<&str> for VignemaleName {
...
impl Borrow<str> for VignemaleName {
    fn borrow(&self) -> &str {
        &self.0
    }
}
...
impl Borrow<String> for VignemaleName {
...
impl Display for VignemaleName {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str(&self.0)
    }
}

impl From<VignemaleName> for String {
    fn from(value: VignemaleName) -> Self {
        value.0
    }
}
